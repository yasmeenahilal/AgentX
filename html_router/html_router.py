...
async def welcome(request: Request, user=Depends(get_user_or_none)):
    ...
    return templates.TemplateResponse(
        "index.html", {"request": request, "active_page": "index"}
    )
...
async def home(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "home.html", {"request": request, "active_page": "home", "user": user}
    )
...
async def show_upload_form(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "insert_data_to_index.html",
        {"request": request, "active_page": "upload", "user": user},
    )
...
async def create_agent(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "create_agent.html",
        {"request": request, "active_page": "create_agent", "user": user},
    )
...
async def list_agents(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "agent_crud.html",
        {"request": request, "active_page": "agent_crud", "user": user},
    )
...
async def delete_agent(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "delete_agent.html",
        {"request": request, "active_page": "delete_agent", "user": user},
    )
...
async def ask_agent(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "ask_agent.html", {"request": request, "active_page": "ask_agent", "user": user}
    )
...
async def profile(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "profile.html", {"request": request, "active_page": "profile", "user": user}
    )
...
async def deployment(request: Request, user=Depends(get_current_user)):
    return templates.TemplateResponse(
        "deployment.html",
        {"request": request, "active_page": "deployment", "user": user},
    )
